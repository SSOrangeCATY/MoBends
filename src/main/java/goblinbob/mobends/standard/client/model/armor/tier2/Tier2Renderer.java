...
public class Tier2Renderer
{
            ...
            Function<Identifier, RenderType> renderTypeProvider)
    {
        ...
        submitWithRenderType(context, model, renderType, true);
    }
            ...
            boolean recordStats)
    {
        ...
        collector.submitCustomGeometry(context.getPoseStack(), renderType, (pose, vertexConsumer) ->
        {
            ...
            renderWithConsumer(context, model, vertexConsumer, submittedPoseStack, recordStats);
        });
    }
    ...
    public <E extends LivingEntity> boolean renderToConsumer(
            ...
            boolean recordStats)
    {
        if (context == null || model == null || vertexConsumer == null || poseStack == null || context.getEntityData() == null)
        {
            return false;
        }
        ...
        try
        {
            renderWithConsumer(context, model, vertexConsumer, poseStack, recordStats);
            return true;
        }
        catch (Exception e)
        {
     ...
     * Uses the public 26.2 model root accessor.
     */
    @Nullable
